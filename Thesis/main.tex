...
% 基本信息--------------------------------------------------------------------------------
% 在这里填写你的论文中文题目
\newcommand{\thesisTitle}{政府数据开放、投资者偏好与地方债务}
% 在这里填写你的论文英文题目
...
% 在这里填写你的相关信息
\newcommand{\deptName}{金融学院}
\newcommand{\majorName}{金融学}
\newcommand{\yourName}{肖文昊}
\newcommand{\yourStudentID}{210404011004}
\newcommand{\mentorName}{陈荣达}
\newcommand{\className}{xxx}
\newcommand{\Today}{2025年5月}
% 基本信息--------------------------------------------------------------------------------
